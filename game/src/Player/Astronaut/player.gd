...
@onready var barrel = $bulletSpawner/Barrel
...
const BULLET = preload("res://src/Player/Astronaut/SurfaceBullet/surface_bullet.tscn")
...
func _process(delta):
	...
	if UnderControl:
		...
		barrel.global_rotation += deg_to_rad(90)
